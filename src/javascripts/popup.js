var Emoty = {};
Emoty.copy = function(text) {
                 var clip = document.getElementById('clipbox');
                 clip.value = text;
                 clip.select();
...
$(function() {
    ...
    function insertImageAndTip(tip, image) {
        $('#images').append(tip).append(image);
    }

    $.each(Emoty.emojis, function(index, value) {
        var tip = createTip(index, value);
        var img = createImg(index, value);
        insertImageAndTip(tip, img);
